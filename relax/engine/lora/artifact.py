    ...
    def validate(self, directory: Path, *, require_provenance: bool = True) -> dict[str, Any]:
        ...
        if require_provenance:
            ...
            if (
                ...
                or type(source.get("export_step")) is not int
                or source["export_step"] < 0
            ):
...
def provenance(contract: ModelContract, directory: Path, *, producer: str, export_step: int) -> dict[str, Any]:
